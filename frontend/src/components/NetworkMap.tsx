    ...
    >
      ...
      {hover && (
        ...
        >
          <div
            className="mono"
            style={{ fontSize: 10, color: "var(--ok)", marginBottom: 3 }}
          >
            {hover.id}
          </div>
          ...
          >
            <span>SIG {hover.signal}%</span>
            <span>LOAD {hover.load}%</span>
          </div>
          {hover.issue && (
            <div
              style={{
                ...
                fontSize: 10.5,
                color:
                  hover.status === "critical" ? "var(--crit)" : "var(--warn)",
              }}
            >
              ⚠ {hover.issue}
            </div>
      ...
      {!compact && (
        <>
          ...
          >
            <Legend c="var(--ok)" t="OPTIMAL" />
            <Legend c="var(--warn)" t="DEGRADED" />
            <Legend c="var(--crit)" t="CRITICAL" />
            {mode === "public" && (
              <Legend c="var(--info)" t="USER REPORT" round />
            )}
          </div>
        </>
      )}
